...
import 'seller/seller_selling_list.dart';
import '../shared/shared_components.dart';
import 'package:intl/intl.dart';

class DataBaseFloatButton extends StatelessWidget {
  final String sele;
  DataBaseFloatButton({required this.sele});
  // DataBaseFloatButton({Key? key, required this.sele}) : super(key: key);
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<ChangeCubit, States>(
        ...
        builder: (context, state) {
          //ChangeCubit stat = ChangeCubit.get(context); here you can use stat object
          //inside this screen instead of using ChangeCubit.get(context). every time
          return Scaffold(
            key: scaffoldKey,
            body: SafeArea(
              child: Material(
            ...
            ), // float button is inside scaffold as body and AppBar not in other widget
          );
        },
      ),
    );
...
// when you call constructor in same page call its name is here in  FloatingButton(),
//but if you go to other page with MaterialPageRoute( builder: (context) => DataBaseFloatButton(),
// as this the page where you will go must be inside material widget as here must be inside material